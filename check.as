...
Guess		WORD	0000001110011110b; 1 6 3 6
Code		WORD	0000110001110011b; 6 1 6 3
...
check:		PUSH	R1 ; preserva R1
		...
		POP	R1
                ...
                ROL	R1, 8 ; coloca a resposta no octeto mais significativo de R1
		MVBH	M[SP + 6], R1 ; O's
...
ciclo_xes:   	MOV	R4, M[SP + 8] ; recupera a jogada
		MOV	R5, M[SP + 7] ; recupera o codigo
...
check_digit:    PUSH	R1 ; preserva R1 ; nao preserva o de R2, para saber quais digitos ja foram retirados
		...
		PUSH	R4 ; preserva R4
                ...
                MOV	R1, 4 ; contador
                MOV	R2, M[SP + 7] ; R2 <- Code - valores previamente encontrados na funcao
                MOV	R4, M[SP + 6]
                MOV	R5, filtro 
...
ciclo_digit:	MOV	R3, R2
		AND	R3, R5 ; aplica filtro
                ...
                OR	R2, R5 ; coloca-se o digito a 7
                BR	ret_digit
